...
export default function FacturesPage() {
  const [factures, setFactures] = useState<FactureResult[]>([]);
  ...
  return (
    <div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            {(search || filterProjet || filterSociete) && (
              <button
                onClick={() => { setSearch(''); setFilterProjet(''); setFilterSociete(''); }}
      ...
      {/* Results table */}
      {loading ? (
        <div className="rom-card p-12 text-center text-gray-500">
